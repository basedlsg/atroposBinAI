#!/usr/bin/env python3
"""
Real Spatial Reasoning System using Google Gemini API
...
class GeminiProvider:
    """Google Gemini API provider for LLM decisions"""
    ...
    def __init__(self, api_key: str = None):
        ...
        print(f"✅ Gemini API configured: {self.api_key[:20]}...")
    
    def get_spatial_decision(self, agent: Agent, obstacles: List[Position], 
                           available_actions: List[str]) -> str:
        """Get spatial reasoning decision from Gemini API"""
...
class SpatialReasoningSystem:
    ...
    def __init__(self, api_key: str = None):
        ...
        print("🚀 Spatial Reasoning System initialized with Gemini API")
    ...
    def run_simulation(self, num_steps: int = 50):
        ...
        for step in range(num_steps):
            ...
            for agent in self.environment.agents:
                ...
                decision = self.gemini_provider.get_spatial_decision(
...
def main():
    ...
    print("🧠 Real Gemini Spatial Reasoning System")
    print("=" * 50)
    ...
    # Initialize system
    system = SpatialReasoningSystem(gemini_key)
    ...
    with open("real_gemini_spatial_results.json", "w") as f:
        json.dump(results, f, indent=2)
    
    print(f"\n💾 Results saved to real_gemini_spatial_results.json")
